<template>
  <div
      class="product-card-container flex items-center gap-10"
    ...
    <div
      ...
      <div class="product-image-container relative">
        ...
        <router-link
          ...
          <img
              class="product-image rounded-lg border-2"
              :src="`${ product.image }`">
        </router-link>
      </div>
      <div class="product-title font-medium text-black text-base">
        {{ product.name }}
      </div>
...
<style scoped>
  ...
  .product-add-to-cart {
    ...
    font-size: 22px;
    color: #3d87ff;
    border: 1px solid #97b98b3d;
    padding: 8px;
    border-radius: 10px;
    line-height: 13px;
    font-weight: 500;
    background-color: #f7f7f8;
    box-shadow: 0px 1px 1px #ececef;
  }

  .product-image {
    border-radius: 20px;
    width: 85px;
    box-shadow: 0px 5px 7px #9797a569;
  }
